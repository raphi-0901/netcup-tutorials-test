...
route: "/tutorials/install-and-configure-ogp-agent-and-csgo-server-in-debian-ubuntu"
...
_We can install Agent in same server where Panel is installed or we can install it in a totally fresh server and link it to panel running on different server._
...
You'll need the encryption key for the panel. _In this case: wq6yw4s5_
