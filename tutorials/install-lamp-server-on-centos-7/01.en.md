...
route: "/tutorials/install-lamp-on-centos-7"
...
**_Note:_** In this example 203.0.113.23 is the IP address of your server
...
**_Note_**: 'holuP455##' is just an example. Replace it with your password.
